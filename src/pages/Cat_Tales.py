    ...
    with st.spinner(spinner_msg):
        ...
        while not got_valid_response:
            ...
            response = chat_session.get_ai_response(
                initial_system_msg=add_cat_names(AI_ASSISTANT_MSG), reinforcement_system_msg=reinforce_with
            )
            ...
            try:
                ...
                if attempts >= max_attempts:
                    ...
                    st.error("Encountered an error generating your story, sorry about that")
                    return
    ...
    if choices.choice1 and choices.choice2:
        with st.form("prompt-form"):
            ...
            if st.form_submit_button("Choose"):
                ...
                # st.session_state.num_choices_made = 0
                # st.session_state.max_choices_per_story = 4
                remaining = st.session_state.max_choices_per_story - st.session_state.num_choices_made
                expect_more = True
                if remaining > 0:
